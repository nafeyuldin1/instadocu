    ...
    <section className={s.cta}>
      ...
      <div className="wrap">
        <div className={s.ctaInner}>
          ...
          <p className={s.ctaP}>Join 1,200+ installation professionals who already manage their documents smarter with Instadocu. Start your free trial today — no credit card required.</p>
